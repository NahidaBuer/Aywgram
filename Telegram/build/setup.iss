#define MyAppShortName "AywGram"
#define MyAppName "AywGram Desktop"
#define MyAppPublisher "NahidaBuer"
#define MyAppURL "https://github.com/NahidaBuer/AywGram"
#define MyAppExeName "AywGram.exe"
#define MyAppId "C9CC98BD-1BBE-4FB4-B544-13A7DD04A280"
...
SignTool=sha256
    ...
    #define MyOutputBaseFilename "aywsetup-arm64." + MyAppVersionFull
  #elif MyBuildTarget == "win64"
    #define MyOutputBaseFilename "aywsetup-x64." + MyAppVersionFull
  #else
    #define MyOutputBaseFilename "aywsetup." + MyAppVersionFull
  #endif
#endif
