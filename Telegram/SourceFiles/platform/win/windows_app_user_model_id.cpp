...
#ifdef OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"AywGram.AywGramDesktop.Store";
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"AywGram.AywGramDesktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"AywGram.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"AywGram Desktop/AywGram.lnk"_q;
